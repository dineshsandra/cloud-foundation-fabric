...
| [tfvars](outputs.tf#L117) | Terraform variables file for the following stages. | ✓ |  |
| [vpn_gateway_endpoints](outputs.tf#L107) | External IP Addresses for the GCP VPN gateways. |  |  |
